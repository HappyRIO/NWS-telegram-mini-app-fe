  ...
  useEffect(() => {
    ...
    function initTg() {
      if (
        ...
        const fetchData = async () => {
          try {
            ...
            const response = await axios.get<GetData>(
              ` https://c1c8-45-126-3-252.ngrok-free.app/api/get-home-data/${tgData.initDataUnsafe.user.id.toString()}`,
              {
                headers: {
        ...
        axios
          .post(
            ` https://c1c8-45-126-3-252.ngrok-free.app/api/get-user/${tgData.initDataUnsafe.user.id.toString()}`,
            {
